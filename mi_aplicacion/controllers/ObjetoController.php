...
require_once 'C:/xampp/htdocs/mi_aplicacion/models/ObjetoModel.php';
...
class ProductoController {
    ...
    public function index() {
        ...
        include 'C:/xampp/htdocs/mi_aplicacion/views/index.php'; // Incluye la vista principal
    }

    // Muestra el formulario para crear un nuevo producto
    public function createForm() {
        include 'c:/xampp/htdocs/mi_aplicacion/views/form.php';
    }
